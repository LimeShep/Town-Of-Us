...
namespace TownOfUs.Roles.Modifiers
{
    public class Assassin : Ability, IGuesser
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            {
                if (CustomGameOptions.DoomsayerOn > 0) ColorMapping.Add("Foreteller", Colors.Doomsayer);
            ...
            if (CustomGameOptions.AssassinGuessNeutralKilling)
            {
                ...
                if (CustomGameOptions.VampireOn > 0 && !PlayerControl.LocalPlayer.Is(RoleEnum.Vampire)) ColorMapping.Add("Jackal", Colors.Vampire);
