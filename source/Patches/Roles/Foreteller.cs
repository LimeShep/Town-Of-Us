...
namespace TownOfUs.Roles
{
    public class Foreteller : Role, IGuesser
    {
        ...
        public Foreteller(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.ForetellerGuessNeutralBenign)
            {
            ...
            if (CustomGameOptions.ForetellerGuessNeutralEvil)
            {
                if (!CustomGameOptions.UniqueRoles) ColorMapping.Add("Foreteller", Colors.Doomsayer);
            ...
            if (CustomGameOptions.ForetellerGuessNeutralKilling)
            {
        ...
        public float ObserveTimer()
        {
            ...
            var num = CustomGameOptions.ForetellerObserveCooldown * 1000f;
        ...
        {
            var foreTeam = new Il2CppSystem.Collections.Generic.List<PlayerControl>();
            foreTeam.Add(PlayerControl.LocalPlayer);
            __instance.teamToShow = foreTeam;
        }
