...
namespace TownOfUs
{
    ...
    public static class CustomGameOptions
    {
        ...
        public static int SpeedrunnerOn => (int)Generate.SpeedrunnerOn.Get();
        public static int SpeedrunnerTasksRemaining => (int)Generate.SpeedrunnerTasksRemaining.Get();
        public static int SpeedrunnerCommonTask => (int)Generate.SpeedrunnerCommonTask.Get();
        public static int SpeedrunnerShortTask => (int)Generate.SpeedrunnerShortTask.Get();
        public static int SpeedrunnerLongTask => (int)Generate.SpeedrunnerLongTask.Get();
        ...
        public static int ForetellerOn => (int)Generate.ForetellerOn.Get();
        ...
        public static bool ImitatorCanBecomePresident => Generate.ImitatorCanBecomePresident.Get();
        ...
        public static bool DraftEnabled => Generate.DraftEnabled.Get();
        public static bool RandomButtonEnabled => Generate.RandomButtonEnabled.Get();
        public static bool RandomBasesOffChoices => Generate.RandomBasesOffChoices.Get();
        public static float PickTime => Generate.PickTime.Get();
        public static int ButtonAmount => (int)Generate.ButtonAmount.Get();
        ...
        public static bool CommsDisableTasks => Generate.CommsDisableTasks.Get();
