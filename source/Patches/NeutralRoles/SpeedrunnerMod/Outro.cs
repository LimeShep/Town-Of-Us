...
namespace TownOfUs.NeutralRoles.SpeedrunnerMod
{
    ...
    public class Outro
    {
        public static void Postfix(EndGameManager __instance)
        {
            ...
            var role = Role.AllRoles.FirstOrDefault(x => x.RoleType == RoleEnum.Speedrunner && ((Speedrunner) x).FinishedAllTasks);
            if (role == null) return;
